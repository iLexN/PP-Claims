...
$app->post('/ajax/address/', 'PP\WebPortal\Controller\Ajax\Address\AjaxController:newOrSave')
        ->add($csrfResponse)
        ->add($container->get('csrf'))
        ->add($authLoginArea)
        ->setName('Ajax.Address.NewOrSave');
$app->post('/ajax/address/{id:\d+}', 'PP\WebPortal\Controller\Ajax\Address\AjaxController:delete')
        ->add($csrfResponse)
        ->add($container->get('csrf'))
        ->add($authLoginArea)
